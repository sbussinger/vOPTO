...
#define RMEbGb(inst)														\
	...
	else {GetEAa;inst(eaa,*rmrb,Mem_Lodsb,Mem_Stosb);}						\
	}
...
#define RMGbEb(inst)														\
	...
	else {GetEAa; inst(*rmrb, Mem_Lodsb(eaa), LoadRb, SaveRb);}			\
	}

#define RMEb(inst)															\
	{																		\
	if (rm >= 0xc0 ) {GetEArb; inst(*earb, LoadRb, SaveRb);}				\
	else {GetEAa; inst(eaa, Mem_Lodsb, Mem_Stosb);}							\
	}
...
#define RMEwGw(inst)														\
	...
	else {GetEAa; inst(eaa, *rmrw, Mem_Lodsw, Mem_Stosw);}					\
	}
...
#define RMEwGwOp3(inst, op3)												\
	...
	else {GetEAa; inst(eaa, *rmrw, op3, Mem_Lodsw, Mem_Stosw);}				\
	}
...
#define RMGwEw(inst)														\
	...
	else {GetEAa; inst(*rmrw, Mem_Lodsw(eaa), LoadRw, SaveRw);}			\
	}																
...
#define RMGwEwOp3(inst, op3)												\
	...
	else {GetEAa; inst(*rmrw, Mem_Lodsw(eaa), op3, LoadRw, SaveRw);}		\
	}																

#define RMEw(inst)															\
	{																		\
	if (rm >= 0xc0 ) {GetEArw; inst(*earw, LoadRw, SaveRw);}				\
	else {GetEAa; inst(eaa, Mem_Lodsw, Mem_Stosw);}							\
	}
...
#define RMGdEd(inst)														\
	...
	else {GetEAa; inst(*rmrd, Mem_Lodsd(eaa), LoadRd, SaveRd);}			\
	}																
...
#define RMEd(inst)															\
	...
	else {GetEAa;inst(eaa, Mem_Lodsd, Mem_Stosd);}							\
	}
